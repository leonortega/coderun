...
fn bench_build_context(c: &mut Criterion) {
    ...
    let task = coderun_core::TaskRequest { message: "implement auth middleware with rate limiting".to_string(), session_id: "bench".to_string(), context_hints: None, repository_id: String::new(), repository_path: None, expected_files: None };
