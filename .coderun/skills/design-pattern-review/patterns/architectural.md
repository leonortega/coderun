...
- Small teams — microservices operational overhead (networking, service discovery, distributed tracing) often outweighs
benefits
...
- Small systems where the event infrastructure (brokers, serialization, dead-letter queues) adds more complexity than it
saves
