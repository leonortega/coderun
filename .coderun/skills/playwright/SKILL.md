...
User-scoped skills install under `$CODEX_HOME/skills` (default: `~/.agents/skills`).
...
Before using this skill for ticketed delivery, read `.agents/skills/_shared/delivery-contract.md` and
